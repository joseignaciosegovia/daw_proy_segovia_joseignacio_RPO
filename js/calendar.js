...
if (function() {
    ...
    if ("undefined" == typeof DayPilot.$) {
        ...
        DayPilot.mo2 = function(e, t) {
            ...
            "undefined" != typeof t.offsetX) {
                ...
                for (var a = t.srcElement; a && a !== e; )
                    "SPAN" !== a.tagName && (i.x += a.offsetLeft,
            ...
            if ("undefined" != typeof t.layerX) {
                ...
                for (var a = t.target; a && "absolute" !== a.style.position && "relative" !== a.style.position; )
                    a = a.parentNode,
                    DayPilot.isKhtml && (i.y += a.scrollTop);
                for (; a && a !== e; )
                    i.x += a.offsetLeft,
        ...
        DayPilot.mo3 = function(e, t) {
            ...
            else if (i = DayPilot.mo2(e, t),
            !i)
                return null;
            return i.shift = t.shiftKey,
            i.meta = t.metaKey,
            i.ctrl = t.ctrlKey,
            i.alt = t.altKey,
            i
        ...
        DayPilot.absOffsetBased = function(e, t) {
            for (var i = {
                ...
                i.y < 0 && (i.h += i.y,
                i.y = 0),
                e.scrollLeft > 0 && i.x + i.w > e.clientWidth && (i.w -= i.x + i.w - e.clientWidth),
        ...
        DayPilot.sheet = function() {
            ...
            e.add = function(e, a, n) {
                return i ? void this.rules.push(e + "{" + a + "}") : void (t.sheet.insertRule ? ("undefined" == typeof n && (n = t.sheet.cssRules.length),
                t.sheet.insertRule(e + "{" + a + "}", n)) : t.sheet.addRule && t.sheet.addRule(e, a, n))
            }
            ,
            e
        }
        ...
        DayPilot.request = function(e, t, i, a) {
            ...
            ,
            4 !== n.readyState && ("object" == typeof i && (i = JSON.stringify(i)),
            n.send(i)))
        }
        ,
        DayPilot.ajax = function(e) {
            ...
            ,
            4 !== t.readyState && (i && (a = JSON.stringify(a)),
            t.send(a))
        }
        ,
        ...
        ,
        DayPilot.Util.overlaps = function(e, t, i, a) {
            return !(t <= i || e >= a)
        }
        ,
        ...
        DayPilot.Areas.attach = function(e, t, i) {
            var i = i || {}
              , n = i.areas
              , o = i.allowed || function() {
                return !0
            }
              , r = i.offsetX || 0;
            n = a(t, n),
            n && DayPilot.isArray(n) && 0 !== n.length && (DayPilot.re(e, "mousemove", function(a) {
        ...
        DayPilot.Areas.showAreas = function(e, t, i, a, n) {
            if (!DayPilot.Global.resizing && !DayPilot.Global.moving && !DayPilot.Global.selecting && !e.active && DayPilot.browser.hover) {
                ...
                if (e.active = {},
                DayPilot.isArray(a) || (a = t.areas,
                a || (t.cache ? a = t.cache.areas : t.data && (a = t.data.areas))),
        ...
        DayPilot.Areas.createArea = function(e, t, i, a) {
            ...
            if ("undefined" != typeof i.style && d.setAttribute("style", i.style),
            ...
            d.style.borderRadius = s(i.borderRadius),
            ...
            i.padding && (d.style.padding = i.padding + "px",
            ...
            if ("ResizeEnd" === i.action || "ResizeStart" === i.action || "Move" === i.action) {
                ...
                d.onmousemove = function(e, t, i) {
                    return function(a) {
                        t.calendar.internal && t.calendar.internal.dragInProgress && t.calendar.internal.dragInProgress() || (a.cancelBubble = !0,
            ...
            if (("ResizeEnd" === i.action || "ResizeStart" === i.action) && t.isEvent && t.calendar.internal.touch) {
                var g = function(e, t, i) {
                    return function(a) {
                        ...
                        n.preventEventTap = !0,
                        t.calendar.isScheduler ? n.startResizing(e, "ResizeEnd" === i.action ? "right" : "left") : t.calendar.isCalendar && n.startResizing(e, "ResizeEnd" === i.action ? "bottom" : "top", r)
                    }
                }(l, t, i);
            ...
            "HoverMenu" === i.action && (d.onmousemove = function(e, t, i) {
                return function(e) {
                    var a = i.menu;
                    a && a.show && (a.visible ? a.source && "undefined" != typeof a.source.id && a.source.id !== t.id && a.show(t) : a.show(t),
                    a.cancelHideTimeout())
                }
            }(e, t, i),
            d.onmouseout = function(e, t, i) {
            ...
            return d.onmousedown = function(e, t, i) {
                return function(a) {
                    if ("function" == typeof i.onmousedown && i.onmousedown(a),
                    ...
                    if ("Move" === i.action && t.isRow) {
                        var o = t.$.row;
                        (0,
                        t.calendar.internal.rowStartMoving)(o)
                    }
                    "undefined" != typeof DayPilot.Bubble && DayPilot.Bubble.hideActive(),
                    "Move" === i.action && (DayPilot.Global.movingAreaData = i.data),
                    "Move" === i.action && t.isEvent && t.calendar.internal && t.calendar.internal.startMoving && t.calendar.internal.startMoving(e, a);
                    "Move" !== i.action && "ResizeEnd" !== i.action && "ResizeStart" !== i.action && i.action && "Default" !== i.action && (a.preventDefault(),
                    a.cancelBubble = !0)
                }
            }(e, t, i),
            ...
            "function" == typeof i.onMouseEnter && d.addEventListener("mouseenter", function(e, t, i) {
                return function(e) {
                    var a = {};
                    a.area = i,
                    a.source = t,
            ...
            "function" == typeof i.onMouseLeave && d.addEventListener("mouseleave", function(e, t, i) {
                return function(e) {
                    var a = {};
                    a.area = i,
                    a.source = t,
        ...
        DayPilot.Areas.hideAreas = function(e, t) {
            if (e && e && e.active) {
                ...
                if (i && i.children && t) {
                    ...
                    if (~DayPilot.indexOf(i.children, n))
                        return
                }
                if (!a || 0 === a.length)
        ...
        DayPilot.Switcher = function(e) {
            function t(e, t, a) {
                ...
                ;
                var o = i.H;
                o && o.start === n.start && o.end === n.end && o.day === n.day && o.target === n.target || (i.H = n,
                "function" == typeof i.onChange && (i.onChange(n),
                n.preventDefault.value) || "function" == typeof i.onTimeRangeSelect && (i.onTimeRangeSelect(n),
                n.preventDefault.value) || (i.k.s(i.l),
                "function" == typeof i.onChanged && i.onChanged(n),
                "function" == typeof i.onTimeRangeSelected && i.onTimeRangeSelected(n)))
            }
            var i = this;
            this.f = [],
            this.i = [],
            ...
            this.addView = function(e, t) {
                ...
                o.s = function(e) {
                    ...
                    )() ? n.commandCallBack && n.commandCallBack("navigate", {
                        "day": e
                    }) : (n.startDate = e,
                    n.update())
                }
                ...
                o.t = function() {
                    i.u(),
                    n.show ? n.show() : n.nav && n.nav.top ? n.nav.top.style.display = "" : n.style.display = ""
                }
                ,
                o.z = function() {
                    if (o.p.navigatorSelectMode)
                        return o.p.navigatorSelectMode;
                    if (n.isCalendar)
                        switch (n.viewType) {
                        case "Day":
                            return "day";
            ...
            this.select = function(e) {
                var t = this.G(e);
                t ? t.E() : this.i.length > 0 && this.i[0].E()
            }
            ,
            this.G = function(e) {
            ...
            this.show = function(e) {
                ...
                this.k = a,
                a.t(),
                null !== i.m && a.control.isCalendar && a.control.setScrollY(i.m);
                var s = a.z();
                i.j.updateMode(s),
        ...
        DayPilot.Date = function(t, i) {
            if (t instanceof DayPilot.Date)
                return t;
            var a;
            DayPilot.Util.isNullOrUndefined(t) && (a = DayPilot.DateUtil.fromLocal().getTime(),
            t = a);
            ...
            var o = !1;
            if ("string" == typeof t)
                a = DayPilot.DateUtil.fromStringSortable(t, i).getTime(),
                o = !0;
        ...
        DayPilot.Date.prototype.addMonths = function(e) {
            ...
            return n.setUTCDate(Math.min(o, t.getUTCDate())),
            new DayPilot.Date(n)
        }
        ,
        ...
        DayPilot.DateUtil.fromStringSortable = function(e, t) {
            ...
            var r = e.substring(0, 4)
              ...
              , l = e.substring(8, 10)
              , d = new Date(0);
            if (d.setUTCFullYear(r, s - 1, l),
            a)
                return DayPilot.Date.Cache.Parsing[e] = d,
                d;
        ...
        DayPilot.DateUtil.daysSpan = function(e, t) {
            ...
            return t.getTime() == t.getDatePart().getTime() && i--,
            i
        }
        ,
        ...
        var n = function(e, i) {
            ...
            this.parse = function(e) {
                ...
                if (DayPilot.Util.isNullOrUndefined(i))
                    return null;
                if (i > 12 || i < 1)
                    return null;
                ...
                if (s < 0 || s > 59)
                    return null;
                var c = new Date;
                return c.setUTCFullYear(t, i - 1, a),
                c.setUTCHours(o),
                c.setUTCMinutes(r),
                c.setUTCSeconds(s),
        ...
        DayPilot.ColorUtil.darker = function(e, t) {
            var i = "";
            9 === e.length && (i = e.slice(7, 9),
            e = e.slice(0, 7));
            var a = DayPilot.ColorUtil.hexToRgb(e);
            "number" != typeof t && (t = 1);
            var n = 17
              , o = Math.round(t * n)
              , r = DayPilot.ColorUtil.adjustLuminance(a, -o);
            return DayPilot.ColorUtil.rgbToHex(r) + i
        }
        ,
        ...
        DayPilot.Event = function(e, t, i) {
            ...
            this.text = function(e) {
                return "undefined" == typeof e ? a.data.text : (this.temp().text = e,
                void this.client.innerHTML(e))
            }
            ,
            ...
            this.tag = function(e) {
                ...
                if ("undefined" == typeof e)
                    return a.data.tag;
                for (var i = a.calendar.tagFields, n = -1, o = 0; o < i.length; o++)
                    e === i[o] && (n = o);
                if (n === -1)
            ...
            this.client.innerHTML = function(e) {
                if ("undefined" == typeof e) {
                    var t = a.cache || a.data
                      , i = a.calendar && a.calendar.internal && a.calendar.internal.xssTextHtml;
...
function() {
    ...
    function t(e) {
        ...
        r.test(e) ? '"' + e.replace(r, function(e) {
            var t = s[e];
    ...
    function i(e, r) {
        ...
        switch (f && "object" == typeof f && "function" == typeof f.toJSON2 ? f = f.toJSON2(e) : f && "object" == typeof f && "function" == typeof f.toJSON && !f.ignoreToJSON && (f = f.toJSON(e)),
        ...
        case "object":
            ...
            if (o && "object" == typeof o)
                ...
                s = 0; s < c; s += 1)
                    l = o[s],
                    "string" == typeof l && (d = i(l, f),
                    d && u.push(t(l) + (a ? ": " : ":") + d));
            else
                for (l in f)
                    Object.hasOwnProperty.call(f, l) && (d = i(l, f),
                    d && u.push(t(l) + (a ? ": " : ":") + d));
            return d = 0 === u.length ? "{}" : a ? "{\n" + a + u.join(",\n" + a) + "\n" + h + "}" : "{" + u.join(",") + "}",
            a = h,
            d
...
function() {
    ...
    if ("undefined" == typeof DayPilot.Calendar || !DayPilot.Calendar.events) {
        ...
        t.getCellsAbove = function(e) {
            for (var i = [], a = t.getColumn(e), n = e.parentNode, o = null; n && o !== t.firstSelected; )
                for (o = n.getElementsByTagName("td")[a],
                i.push(o),
                n = n.previousSibling; n && "TR" !== n.tagName; )
                    n = n.previousSibling;
            return i
        }
        ,
        t.getCellsBelow = function(e) {
            for (var i = [], a = t.getColumn(e), n = e.parentNode, o = null; n && o !== t.firstSelected; )
                for (o = n.getElementsByTagName("td")[a],
                i.push(o),
                n = n.nextSibling; n && "TR" !== n.tagName; )
                    n = n.nextSibling;
            return i
        }
        ,
        ...
        t.gMouseUp = function(i) {
            if (t.resizing) {
                if (!t.resizingShadow)
                    return t.resizing.style.cursor = "default",
                ...
                a.calendar.J(a, n, o, r)
            } else if (t.moving) {
                if (!t.movingShadow)
                    return t.moving = null,
                ...
                DayPilot.Util.removeClass(t.moving, a.calendar.K("_event_moving_source"));
                var s = t.movingShadow.column;
                t.moving = null,
                DayPilot.Global.moving = null,
                t.movingShadow = null,
                a.calendar.nav.top.style.cursor = "auto",
                a.calendar.L(a, s, o, i)
            } else if (DayPilot.Global.selecting) {
                var l = DayPilot.Global.selecting.calendar;
                l.M = DayPilot.Global.selecting,
                DayPilot.Global.selecting = null;
                var d = l.getSelection();
                l.N(d.start, d.end, d.resource),
                "Hold" !== l.timeRangeSelectedHandling && "HoldForever" !== l.timeRangeSelectedHandling && e()
            } else
                t.selecting = !1
        }
        ,
        ...
        ;
        var i = DayPilot.Util.isVueVNode
          , a = DayPilot.Util.overlaps;
        t.Calendar = function(e, n) {
            var o = !1;
            if (this instanceof t.Calendar && !this.O && (o = !0,
            this.O = !0),
            !o)
            ...
            this.T = function(e, t, i) {
                ...
                a.header = this.S();
                var n = "JSON" + DayPilot.JSON.stringify(a);
                this.backendUrl ? DayPilot.request(this.backendUrl, this.U, n, this.ajaxError) : "function" == typeof WebForm_DoCallback && WebForm_DoCallback(this.uniqueID, n, this.V, this.clientName, this.onCallbackError, !0)
            }
            ,
            ...
            this.aa = function(e, t) {
                ...
                n.style.zIndex = 101,
                n.className = r.K("_shadow");
                var o = document.createElement("div");
                return o.className = r.K("_shadow_inner"),
                a && (o.style.borderRadius = a,
                n.style.borderRadius = a),
                n.appendChild(o),
            ...
            this.ba.locale = function() {
                var e = DayPilot.Locale.find(r.locale);
                return e ? e : DayPilot.Locale.US
            }
            ,
            this.ba.timeFormat = function() {
            ...
            this.ba.ea = function() {
                ...
                if (e >= 60)
                    return 60;
                var t = [1, 2, 3, 4, 5, 6, 10, 12, 15, 20, 30, 60]
                  , i = Math.floor(e);
                return Math.max.apply(null, t.filter(function(e) {
                    return e <= i
                }))
            }
            ;
            ...
            this.V = function(e, t) {
                ...
                if ("None" === e.UpdateType)
                    return r.loadingStop(),
                    void r.t();
                if (r.X(),
                "Full" === e.UpdateType && (r.columns = e.Columns,
                r.days = e.Days,
                r.startDate = new DayPilot.Date(e.StartDate),
                r.heightSpec = e.HeightSpec ? e.HeightSpec : r.heightSpec,
                r.businessBeginsHour = e.BusinessBeginsHour ? e.BusinessBeginsHour : r.businessBeginsHour,
                r.businessEndsHour = e.BusinessEndsHour ? e.BusinessEndsHour : r.businessEndsHour,
                r.headerDateFormat = e.HeaderDateFormat ? e.HeaderDateFormat : r.headerDateFormat,
                r.viewType = e.ViewType,
                r.backColor = e.BackColor ? e.BackColor : r.backColor,
                r.eventHeaderVisible = e.EventHeaderVisible ? e.EventHeaderVisible : r.eventHeaderVisible,
                r.timeFormat = e.TimeFormat ? e.TimeFormat : r.timeFormat,
                ...
                r.ma(),
                r.clearSelection(),
                r.afterRender(e.CallBackData, !0),
                r.loadingStop()
            }
            ,
            this.na = function() {
            ...
            ,
            this.qa = function() {
                return this.oa() / (60 * s.ea() * 1e3)
            }
            ,
            this.oa = function() {
                var e = 0;
                return e = "BusinessHoursNoScroll" === this.heightSpec ? this.pa() : 24,
                60 * e * 60 * 1e3
            }
            ,
            this.ra = function() {
            ...
            this.ta = function(e) {
                ...
                if (i.client.clickEnabled())
                    if (r.sa()) {
                        ...
                        ,
                        "function" == typeof r.onEventClick && (r.ua.apply(function() {
                            r.onEventClick(a)
                        }),
                        ...
                        "function" == typeof r.onEventClicked && r.ua.apply(function() {
                            r.onEventClicked(a)
                        })
                    } else
                        switch (r.eventClickHandling) {
            ...
            this.va = function(e) {
                ...
                ,
                "function" == typeof r.onEventRightClick && (r.onEventRightClick(i),
                ...
                return "function" == typeof r.onEventRightClicked && r.onEventRightClicked(i),
                e.preventDefault && e.preventDefault(),
                !1
            }
            ,
            this.eventDeleteCallBack = function(e, t) {
                this.T("EventDelete", t, e)
            }
            ,
            ...
            this.wa = function(e) {
                if (r.sa()) {
                    ...
                    ,
                    "function" == typeof r.onEventDelete && (r.ua.apply(function() {
                        r.onEventDelete(t)
                    }),
                    ...
                    "function" == typeof r.onEventDeleted && r.ua.apply(function() {
                        r.onEventDeleted(t)
                    })
                } else
                    switch (r.eventDeleteHandling) {
            ...
            this.J = function(e, t, i, a) {
                ...
                if ("top" === a) {
                    ...
                    var u = c.getDatePart()
                      , h = Math.floor((i + t - n) / r.cellHeight);
                ...
                if (r.sa()) {
                    ...
                    ,
                    "function" == typeof r.onEventResize && (r.ua.apply(function() {
                        r.onEventResize(v)
                    }),
                    ...
                    "function" == typeof r.onEventResized && r.ua.apply(function() {
                        r.onEventResized(v)
                    })
                } else
                    switch (r.eventResizeHandling) {
            ...
            this.eventMoveCallBack = function(e, t, i, a, n) {
                ...
                o.newStart = t,
                o.newEnd = i,
                this.T("EventMove", n, o)
            }
            ,
            this.L = function(e, t, i, a) {
                var n = 1
                  , o = Math.floor((i - n) / r.cellHeight);
                ...
                var l = s.ea()
                  ...
                  , u = e.end()
                  , h = new Date;
                c instanceof DayPilot.Date && (c = c.toDate()),
                h.setTime(Date.UTC(c.getUTCFullYear(), c.getUTCMonth(), c.getUTCDate()));
                var f = c.getTime() - (h.getTime() + 3600 * c.getUTCHours() * 1e3 + Math.floor(c.getUTCMinutes() / l) * l * 60 * 1e3);
                "Never" === r.useEventBoxes && (f = 0);
                var m = u.getTime() - c.getTime()
                  , p = this.xa[t]
                  , v = p.id;
                r.snapToGrid || (f = 0);
                var y = p.start.getTime()
                  , g = new Date;
                g.setTime(y + d + f);
                var b = new DayPilot.Date(g)
                  , D = b.addTime(m);
                if (r.sa()) {
                    var x = {};
                    if (x.e = e,
                    ...
                    ,
                    "function" == typeof r.onEventMove && (r.ua.apply(function() {
                        r.onEventMove(x)
                    }),
                    x.preventDefault.value))
                        return;
                    ...
                    "function" == typeof r.onEventMoved && r.ua.apply(function() {
                        r.onEventMoved(x)
                    })
                } else
                    switch (r.eventMoveHandling) {
            ...
            this.timeRangeSelectedCallBack = function(e, t, i, a) {
                ...
                n.start = e,
                n.end = t,
                this.T("TimeRangeSelected", a, n)
            }
            ,
            this.N = function(e, t, i) {
                if (e = new DayPilot.Date(e),
                t = new DayPilot.Date(t),
                this.sa()) {
                    var a = {};
                    if (a.start = e,
                    ...
                    ,
                    "function" == typeof r.onTimeRangeSelect && (r.ua.apply(function() {
                    ...
                    "function" == typeof r.onTimeRangeSelected && r.ua.apply(function() {
            ...
            this.ya = function(e) {
                if (!DayPilot.Global.selecting && "Disabled" !== r.timeRangeSelectedHandling) {
                    ...
                    if (1 === t || 0 === t) {
                        ...
                        return i.start.time = r.za(r.coords.x, r.coords.y),
                        i.start.columnIndex = r.Aa(r.coords.x),
                        i.start.column = r.xa[i.start.columnIndex],
                        r.Ba(),
                        r.Ca(),
                        !1
                    }
            ...
            this.Ca = function() {
                ...
                !function() {
                    var t = e.start.column
                      , i = e.start.columnIndex
                      , a = t.start
                      , n = r.getPixels(e.startTime, a)
                      , o = r.getPixels(e.endTime, a)
                      , s = n.boxTop
                      , l = o.boxBottom;
                    r.snapToGrid || (s = n.top,
                    l = o.top);
                    var d = l - s
                      , c = r.eventBorderRadius;
                    ...
                    var u = function() {
                        ...
                        t.className = r.K("_shadow_inner"),
                        c && (t.style.borderRadius = c,
                        e.style.borderRadius = c),
                        e.appendChild(t),
                        r.nav.events.rows[0].cells[i].selection.appendChild(e),
                        r.elements.selection.push(e),
                        r.nav.activeSelection = e,
                        e
                    }();
                    u.className = r.K("_shadow"),
            ...
            this.Ba = function() {
                var e = DayPilot.Global.selecting;
                e.end = r.coords,
                e.end.time = r.za(e.start.x, e.end.y),
                e.end.column = r.xa[r.Aa(e.end.x)],
                r.Da && (e.end.time = r.za(e.end.x, e.end.y)),
                r.Ea(e)
            }
            ,
            this.Ea = function(e) {
                var t, i, a;
                r.snapToGrid ? e.end.time < e.start.time ? (t = r.Fa(e.end.time, e.start.column.start),
                i = r.Ga(e.start.time, e.start.column.start),
                a = e.endTime) : (t = r.Fa(e.start.time, e.start.column.start),
                i = r.Ga(e.end.time, e.start.column.start),
                a = e.startTime) : e.end.time < e.start.time ? (t = e.end.time,
                i = e.start.time,
                a = e.endTime) : (t = e.start.time,
                i = e.end.time,
                a = e.startTime),
                e.startTime = t,
                e.endTime = i,
            ...
            this.za = function(e, t) {
                ...
                var i = this.Aa(e)
                  , a = t / (60 / s.ea()) / r.cellHeight
                  , n = 60 * a * 60 * 1e3
                  , o = 6e4 * Math.floor(n / 6e4)
                  , l = o
                  , d = this.xa[i];
                if (!d)
                    return null;
            ...
            this.Ga = function(e, t) {
                var i = this.Fa(e, t);
                return i.getTime() === e.getTime() ? i : i.addTime(60 * s.ea() * 1e3)
            }
            ,
            this.Ha = {},
            this.Ha.getCellCoords = function() {
                var e = {};
                if (e.x = 0,
                e.y = 0,
                !r.coords)
                ...
                e.x = r.Aa(r.coords.x);
                var t = 0
                  , i = Math.floor((r.coords.y - t) / r.cellHeight);
                return e.y = i,
                e.x < 0 ? null : e
            }
            ,
            ...
            this.fa = function() {
                var e;
                e = "Resources" !== r.viewType ? this.Ja() : r.columns.list,
                this.xa = [];
                for (var t = 0; t < e.length; t++) {
                    var i = this.Ka(e[t]);
                    this.xa.push(i)
            ...
            this.Ka = function(e) {
                ...
                t.toolTip = e.toolTip,
                t.data = e,
                e.start ? t.start = new DayPilot.Date(e.start) : t.start = new DayPilot.Date(r.startDate),
            ...
            this.Ja = function() {
                ...
                for (var n = 0; n < i; n++) {
                    var o = r.headerDateFormat ? r.headerDateFormat : s.locale().datePattern
                      , l = {};
                    l.start = t.addDays(n),
                    l.name = l.start.toString(o, s.locale()),
                    e.push(l)
                }
                return e
            }
            ...
            this.La = function(e) {
                !function() {
                    var t = e.domArgs;
                    if (e.domArgs = null,
                    t && "function" == typeof r.onBeforeEventDomRemove && r.onBeforeEventDomRemove(t),
                    t && "function" == typeof r.onBeforeEventDomAdd) {
                        var a = t && t.Ma;
                        if (a) {
                            r.Oa.Na && i(t.element) && (r.Oa.Pa = !0,
                            r.Oa.Qa(a),
                            r.Oa.Pa = !1)
                        }
                    }
            ...
            ,
            this.Ra = function(e) {
                var a = e.cache || e.data
                  , n = this.nav.events
                  , o = a.borderRadius || r.eventBorderRadius;
                "number" == typeof o && (o += "px");
                var s = document.createElement("div");
                s.style.position = "absolute",
                s.style.left = e.part.left + "%",
                s.style.top = e.part.top + "px",
                s.style.width = e.part.width + "%",
                s.style.height = Math.max(e.part.height, 2) + "px",
                ...
                s.className = this.K("_event"),
                a.cssClass && DayPilot.Util.addClass(s, a.cssClass),
                r.showToolTip && e.client.toolTip() && (s.title = e.client.toolTip()),
                s.isFirst = e.part.start.getTime() === e.start().getTime(),
                s.isLast = e.part.end.getTime() === e.end().getTime(),
                s.onclick = this.ta,
                DayPilot.re(s, "contextmenu", this.va),
                s.onmouseout = function(e) {
                    s.deleteIcon && (s.deleteIcon.style.display = "none")
                }
                ,
                s.onmousemove = function(i) {
                    ...
                    if ("undefined" != typeof t) {
                        ...
                        if (n && !t.resizing && !t.moving) {
                            ...
                            var o = this.isLast;
                            n.y <= a && e.client.resizeEnabled() ? (this.style.cursor = "n-resize",
                            this.dpBorder = "top") : this.offsetHeight - n.y <= a && e.client.resizeEnabled() ? o ? (this.style.cursor = "s-resize",
                            this.dpBorder = "bottom") : this.style.cursor = "not-allowed" : t.resizing || t.moving || ("Disabled" !== r.eventClickHandling ? this.style.cursor = "pointer" : this.style.cursor = "default")
                        }
                    }
                }
                ,
                s.onmousedown = function(i) {
                    ...
                    if ("n-resize" !== this.style.cursor && "s-resize" !== this.style.cursor || 1 !== a) {
                        if (1 === a && e.client.moveEnabled()) {
                            ...
                            n.oldColumn = r.xa[this.data.part.dayIndex].id,
                            t.originalMouse = DayPilot.mc(i),
                            t.originalTop = this.offsetTop;
                            var o = DayPilot.mo3(this, i);
                            o ? t.moveOffsetY = o.y : t.moveOffsetY = 0,
                            r.nav.top.style.cursor = "move"
                        }
                    } else
                        t.resizing = this,
                        ...
                        t.originalTop = this.offsetTop,
                        r.nav.top.style.cursor = this.style.cursor;
                    return !1
                }
                ;
                var l = document.createElement("div");
                if (l.setAttribute("unselectable", "on"),
                l.className = r.K("_event_inner"),
                "darker" === a.borderColor && a.backColor ? l.style.borderColor = DayPilot.ColorUtil.darker(a.backColor, 2) : l.style.borderColor = a.borderColor,
                a.backColor && (l.style.background = a.backColor),
                a.fontColor && (l.style.color = a.fontColor),
                o && (s.style.borderRadius = o,
                l.style.borderRadius = o),
                s.appendChild(l),
                e.client.barVisible()) {
                    var d = e.part.height - 2
                      , c = 100 * e.part.barTop / d
                      , u = Math.ceil(100 * e.part.barHeight / d)
                      , h = document.createElement("div");
                    h.setAttribute("unselectable", "on"),
                    h.className = this.K("_event_bar"),
                    h.style.position = "absolute",
                    a.barBackColor && (h.style.backgroundColor = a.barBackColor);
                    var f = document.createElement("div");
                    f.setAttribute("unselectable", "on"),
                    f.className = this.K("_event_bar_inner"),
                    f.style.top = c + "%",
                    0 < u && u <= 1 ? f.style.height = "1px" : f.style.height = u + "%",
                    a.barColor && (f.style.backgroundColor = a.barColor),
                    h.appendChild(f),
                    s.appendChild(h)
                }
                ...
                if (function() {
                    ...
                    t.element = null,
                    s.domArgs = t,
                    "function" == typeof r.onBeforeEventDomAdd && r.onBeforeEventDomAdd(t),
                    t.element) {
                        var a = l;
                        if (a) {
                            t.Ma = a;
                ...
                n.rows[0].cells[e.part.dayIndex]) {
                    n.rows[0].cells[e.part.dayIndex].firstChild.appendChild(s),
                    r.Ta(s)
                }
            ...
            this.Ta = function(e) {
                for (var t = e && e.childNodes ? e.childNodes.length : 0, i = 0; i < t; i++)
                    try {
                        ...
                        1 === a.nodeType && (a.unselectable = "on",
                        this.Ta(a))
                    } catch (e) {}
            }
            ,
                        ...
                        for (var i = 0; i < t.blocks.length; i++)
                            for (var a = t.blocks[i], n = 0; n < a.lines.length; n++)
                                for (var o = a.lines[n], r = 0; r < o.length; r++) {
                                    ...
                                    l || (s.part.width = 1.5 * s.part.width),
                                    this.Ra(s)
                                }
                }
            }
            ...
            this.Ua = function() {
                ...
                DayPilot.Util.addClass(this.nav.top, this.K("_main")),
                ...
                this.nav.scroll.style.height = this.Va() + "px",
                ...
                this.nav.loading.innerHTML = r.Ya(r.loadingLabelText, r.loadingLabelHtml),
            ...
            this._a = function() {
                ...
                for (var t = this.xa, i = t.length, a = e.insertRow(-1), n = 0; n < i; n++) {
                    ...
                    r.rtl || (o.style.textAlign = "left");
                    var s = document.createElement("div");
                    s.style.marginRight = r.columnMarginRight + "px",
                    s.style.marginLeft = r.columnMarginLeft + "px",
            ...
            this.ab = function(e, t) {
                ...
                o.className = this.K("_rowheader"),
                o.style.width = this.hourWidth + "px",
                o.style.height = i + "px",
                o.style.overflow = "hidden",
                o.unselectable = "on";
                var l = document.createElement("div");
                l.className = this.K("_rowheader_inner"),
                l.unselectable = "on";
                var d = document.createElement("div");
                d.unselectable = "on";
                var c = this.startDate.addHours(t).addHours(r.ra())
                  , u = c.getHours()
                  , h = u < 12
                  , f = s.timeFormat();
                "Clock12Hours" === f && (u %= 12,
                ...
                m.unselectable = "on",
                m.className = this.K("_rowheader_minutes");
                var p;
            ...
            this.Wa = function() {
                ...
                if (a.appendChild(this.nav.header),
                o) {
                    a = i.insertCell(-1),
                    a.unselectable = "on";
                    ...
                    r.className = this.K("_cornerright");
                    var s = document.createElement("div");
                    s.className = this.K("_cornerright_inner"),
                    r.appendChild(s),
                    a.appendChild(r),
            ...
            this.cb = function() {
                ...
                t.className = this.K("_corner_inner"),
                e.appendChild(t),
                e
            }
            ,
            ...
            this.db = function(e) {
                e && (!function() {
                    var t = e
                      , a = t.domArgs;
                    if (t.domArgs = null,
                    a && "function" == typeof r.onBeforeCellDomRemove && r.onBeforeCellDomRemove(a),
                    a && "function" == typeof r.onBeforeCellDomAdd) {
                        var n = a && a.Ma;
                        if (n) {
                            r.Oa.Na && i(a.element) && (r.Oa.Pa = !0,
                            r.Oa.Qa(n),
                            r.Oa.Pa = !1)
                        }
                    }
            ...
            this.ja = function() {
                ...
                for (a && this.Y(); a && a.rows && a.rows.length > 0; )
                    this.fasterDispose || DayPilot.pu(a.rows[0]),
                    a.deleteRow(0);
                this.tableCreated = !0;
                for (var d = l.length, c = this.nav.events; c && c.rows && c.rows.length > 0; )
                    this.fasterDispose || DayPilot.pu(c.rows[0]),
                    c.deleteRow(0);
                for (var d = l.length, u = c.insertRow(-1), h = 0; h < d; h++) {
                    ...
                    r.rtl || (f.style.textAlign = "left");
                    var m = document.createElement("div");
                    m.style.marginRight = r.columnMarginRight + "px",
                    m.style.marginLeft = r.columnMarginLeft + "px",
                ...
                for (var v = 0; v < o; v++) {
                    ...
                    for (var h = 0; h < d; h++) {
                        var y = this.xa[h]
                          , f = u.insertCell(-1);
                        f.start = y.start.addTime(v * n),
                        f.end = f.start.addTime(n),
                        f.resource = y.id,
                        f.onmousedown = this.ya,
                        ...
                        f.style.height = r.cellHeight + "px",
                        f.style.overflow = "hidden",
                        f.unselectable = "on";
                        var m = document.createElement("div");
                        m.unselectable = "on",
                        m.style.height = r.cellHeight + "px",
                        m.style.position = "relative",
                        m.className = this.K("_cell");
                        var g = this.eb(f.start, f.end)
                          , b = {
                            "business": g,
                            "text": null,
                            "html": null,
                        ...
                        !function() {
                            if ("function" == typeof r.onBeforeCellRender) {
                                var e = {};
                                e.cell = D,
                                r.onBeforeCellRender(e)
                            }
                        }(),
                        b.business && DayPilot.Util.addClass(m, r.K("_cell_business")),
                        b.cssClass && DayPilot.Util.addClass(m, b.cssClass);
                        var x = document.createElement("div");
                        x.setAttribute("unselectable", "on"),
                        x.className = this.K("_cell_inner");
                        var w = DayPilot.Util.escapeTextHtml(b.text, b.html);
                        w && (x.innerHTML = w),
                        b.backColor && (x.style.backgroundColor = b.backColor),
                        b.backImage && (x.style.backgroundImage = "url(" + b.backImage + ")"),
                        b.backRepeat && (x.style.backgroundRepeat = b.backRepeat),
                        b.fontColor && (x.style.color = b.fontColor),
                        m.appendChild(x),
                        function() {
                            if ("function" == typeof r.onBeforeCellDomAdd || "function" == typeof r.onBeforeCellDomRemove) {
                                ...
                                e.element = null,
                                f.domArgs = e,
                                "function" == typeof r.onBeforeCellDomAdd && r.onBeforeCellDomAdd(e),
                                e.element) {
                                    var t = x;
                                    if (t) {
                                        e.Ma = t;
                ...
                a.root = this,
                r.nav.scrollable.onmousemove = function(e) {
                    ...
                    if (t.resizing) {
                        ...
                        if ("bottom" === t.resizing.dpBorder) {
                            ...
                            r.snapToGrid && (l = Math.floor((t.originalHeight + t.originalTop + s + n / 2) / n) * n - t.originalTop + o),
                            l < n && (l = n);
                            ...
                            r.snapToGrid && (c = Math.floor((t.originalTop + s - o + n / 2) / n) * n + o),
                            c < o && (c = o),
                            c > t.originalTop + t.originalHeight - n && (c = t.originalTop + t.originalHeight - n);
                            var l = t.originalHeight - (c - t.originalTop);
                            l < n ? l = n : t.resizingShadow.style.top = c + "px",
                            t.resizingShadow.style.height = l + "px"
                        }
                    } else if (t.moving) {
                        if (!r.coords)
                        ...
                        if (!t.movingShadow) {
                            var u = 3
                              , a = DayPilot.mc(e)
                              , h = Math.abs(a.x - t.originalMouse.x) + Math.abs(a.y - t.originalMouse.y);
                            if (h <= u)
                                return;
                            t.movingShadow = r.aa(t.moving, !0, r.shadow),
                        ...
                        f || (f = n / 2);
                        var c = r.coords.y - f;
                        r.snapToGrid && (c = Math.floor((r.coords.y - f - o + n / 2) / n) * n + o),
                        c < o && (c = o);
                        var m = r.nav.events
                          , d = r.nav.main.clientHeight + o
                          , p = parseInt(t.movingShadow.style.height);
                        c + p > d && (c = d - p),
                        DayPilot.Util.addClass(t.moving, r.K("_event_moving_source")),
                        t.movingShadow.parentNode.style.display = "none",
                        t.movingShadow.style.top = c + "px",
                        t.movingShadow.parentNode.style.display = "";
                        var v = m.clientWidth / m.rows[0].cells.length
                          , y = Math.floor((r.coords.x - 45) / v);
                        y < 0 && (y = 0),
                        y < m.rows[0].cells.length && y >= 0 && t.movingShadow.column !== y && (t.movingShadow.column = y,
                        t.moveShadow(m.rows[0].cells[y]));
                    } else
                        DayPilot.Global.selecting && (r.Ba(),
                        r.Ca())
                }
                ,
            ...
            this.fb = function(e) {
                function t(t) {
                    var n = a[t]
                      , o = e ? i.insertCell(-1) : i.cells[t];
                    o.data = n,
                    o.style.overflow = "hidden",
                    o.style.padding = "0px",
                    o.style.border = "0px none",
                    o.style.height = r.headerHeight + "px",
                    o.onclick = r.gb;
                    ...
                    l.className = r.K("_colheader"),
                    l.style.height = r.headerHeight + "px",
                    r.headerTextWrappingEnabled || (l.style.whiteSpace = "nowrap"),
                    s = document.createElement("div"),
                    s.className = r.K("_colheader_inner"),
                    s.unselectable = "on",
                    l.appendChild(s),
                    o.appendChild(l)) : s = l.firstChild;
                    var d = {};
                    d.header = {},
                    d.header.cssClass = null,
                    d.header.verticalAlignment = "center",
                    d.header.horizontalAlignment = "center",
                    d.column = r.hb(n, r),
                    "function" == typeof r.onBeforeHeaderRender && (DayPilot.Util.copyProps(n, d.header, ["id", "start", "name", "html", "backColor", "toolTip", "areas"]),
                    r.onBeforeHeaderRender(d),
                    DayPilot.Util.copyProps(d.header, n, ["html", "backColor", "toolTip", "areas", "cssClass", "verticalAlignment", "horizontalAlignment"])),
                    n.toolTip && (s.title = n.toolTip),
                    n.cssClass && DayPilot.Util.addClass(l, n.cssClass),
                    n.backColor && (s.style.background = n.backColor),
                    n.areas && DayPilot.Areas.attach(l, n);
                    var c = n.verticalAlignment;
                    if (c)
                        switch (s.style.display = "flex",
                        c) {
                        case "center":
            ...
            this.gb = function(e) {
                if ("Disabled" !== r.headerClickHandling) {
                    ...
                    ,
                    "function" == typeof r.onHeaderClick && (r.onHeaderClick(a),
                    a.preventDefault.value) || "function" == typeof r.onHeaderClicked && r.onHeaderClicked(a)
                }
            }
            ,
            this.hb = function(e) {
                return new DayPilot.CalendarColumn(e,r)
            }
            ,
            this.ib = function() {
            ...
            this.ia = function() {
                ...
                for (i.length; this.headerCreated && e && e.rows && e.rows.length > 0; )
                    this.fasterDispose || DayPilot.pu(e.rows[0]),
                    e.deleteRow(0);
            ...
            this.events.forRange = function(e, t) {
                ...
                t = new DayPilot.Date(t),
                (r.events.list || []).filter(function(i) {
                    return a(e, t, new DayPilot.Date(i.start), new DayPilot.Date(i.end))
                }).map(function(e) {
            ...
            this.events.load = function(e, t, i) {
                ...
                if (r.eventsLoadMethod && "POST" === r.eventsLoadMethod.toUpperCase())
                    ...
                    var o = e
                      , s = "start=" + r.visibleStart().toString() + "&end=" + r.visibleEnd().toString();
                    o += o.indexOf("?") > -1 ? "&" + s : "?" + s,
                    DayPilot.Http.ajax({
                        "method": "GET",
                        "url": o,
            ...
            this.pb = function() {
                if (r.nav.top.className !== r.K("_main")) {
                    ...
                    var e = r.nav.corner;
                    e.className = r.K("_corner"),
                    e.firstChild.className = r.K("_corner_inner");
                    var t = r.nav.cornerRight;
                    t && (t.className = r.K("_cornerright"),
                    t.firstChild.className = r.K("_cornerright_inner"))
                }
            }
            ,
                ...
                if (e) {
                    var t = {
                        "events": {
                            "preInit": function() {
                                var e = this.data || [];
                                DayPilot.isArray(e.list) ? r.events.list = e.list : r.events.list = e
                            }
                        },
                        "columns": {
                            "preInit": function() {
            ...
            this.vb.events = [],
            this.wb = function(e) {
                var t = this.vb.events
                  , i = this.events.list[e]
                  , a = {};
                for (var n in i)
                    a[n] = i[n];
                if (a.start = new DayPilot.Date(i.start),
                a.end = new DayPilot.Date(i.end),
                ...
                e) {
                    ...
                    for (var n = 0; n < this.xa.length; n++) {
                        ...
                        for (var c = new DayPilot.Date(d.start), u = c.getTime(), h = c.addTime(i), f = h.getTime(), m = 0; m < t; m++)
                            if (!a[m]) {
                                var o = e[m]
                                  , p = new DayPilot.Date(o.start)
                                  , v = new DayPilot.Date(o.end)
                                  , y = p.getTime()
                                  , g = v.getTime();
                                if (!(g < y)) {
                                    var b = !(g <= u || y >= f);
                                    if ("Resources" === r.viewType && (b = b && d.id === o.resource),
                                    b) {
                                        var D = new DayPilot.Event(o,r);
                                        D.part.dayIndex = n,
                                        D.part.start = u < y ? p : c,
                                        D.part.end = f > g ? v : h;
                                        ...
                                        if (C === P && (x.cut || w.cut))
                                            continue;
                                        var k = w.boxBottom
                                          , _ = "Always" === r.useEventBoxes;
                                        _ ? (D.part.top = Math.floor(C / this.cellHeight) * this.cellHeight + 1,
                                        D.part.height = Math.max(Math.ceil(k / this.cellHeight) * this.cellHeight - D.part.top, this.cellHeight - 1) + 1) : (D.part.top = C + 1,
                                        D.part.height = P - C + 1),
                                        ...
                                        d.events.push(D),
                                        "function" == typeof this.onBeforeEventRender && (D.cache = this.vb.events[m]),
                                        D.part.start.getTime() === y && D.part.end.getTime() === g && (a[m] = !0)
                                    }
                                }
                            }
                    }
            ...
            this.debug = function(e, t) {
                this.debuggingEnabled && (r.debugMessages || (r.debugMessages = []),
                r.debugMessages.push(e),
            ...
            this.getPixels = function(e, t) {
                ...
                h.top = this.yb(l),
                h.boxTop = this.yb(c),
                h.boxBottom = this.yb(u),
                this.cache.pixels[a + "_" + i] = h,
                h
            }
            ,
            this.yb = function(e) {
                return Math.floor(this.cellHeight * e / (6e4 * s.ea()))
            }
            ,
            this.zb = function(e) {
                var t = Math.floor((shadowTop - _startOffset) / r.cellHeight);
                r.snapToGrid || (t = (shadowTop - _startOffset) / r.cellHeight);
                s.ea()
            }
            ,
            this.rb = function() {
            ...
            this.ua = {},
            this.ua.scope = null,
            this.ua.notify = function() {
                r.ua.scope && r.ua.scope["$apply"]()
            }
            ,
            this.ua.apply = function(e) {
                e()
            }
            ,
            this.lb = function() {
                if (r.nav.scroll && r.Ab()) {
                    var e = r.nav.scroll.scrollTop
                      , t = s.ea()
                      , i = 60 / t
                      , a = e / (i * r.cellHeight);
                    r.Bb.scrollHour = a
            ...
            this.kb = function() {
                var e = 0
                  , t = 60 / s.ea();
                e = "number" == typeof r.Bb.scrollHour ? t * r.cellHeight * r.Bb.scrollHour : "Auto" === r.initScrollPos ? "BusinessHours" === this.heightSpec ? t * this.cellHeight * this.businessBeginsHour : 0 : this.initScrollPos;
                var i = r.nav.top;
                "none" === i.style.display ? (i.style.display = "",
                r.nav.scroll.scrollTop = e,
                i.style.display = "none") : r.nav.scroll.scrollTop = e
            }
            ,
            ...
            this.Fb = function() {
                this.Bb.themes = [],
                this.Bb.themes.push(this.theme || this.cssClassPrefix)
            }
            ,
            this.Gb = function() {
            ...
            this.Ya = function(e, t) {
                return r.ba.ca() ? DayPilot.Util.escapeTextHtml(e, t) : DayPilot.Util.isNullOrUndefined(t) ? DayPilot.Util.isNullOrUndefined(e) ? "" : e : t
            }
            ,
            this.Oa = {},
            this.Oa.Na = null,
            this.Oa.Kb = function(e, t, i) {
                var a = r.Oa.Na;
            ...
            ,
            this.Oa.Qa = function(e) {
                var t = r.Oa.Na;
                "function" == typeof t.render && t.render(null, e)
            }
            ,
            this.internal = {},
            this.internal.loadOptions = r.qb,
            this.internal.xssTextHtml = r.Ya,
...
if (function() {
    "undefined" != typeof DayPilot.DatePicker && DayPilot.DatePicker.close || (DayPilot.DatePicker = function(e) {
        ...
        this.init = function() {
            ...
            var e = this.Lb();
            this.resetTarget && !e ? this.Mb(this.date) : this.resetTarget || (i.date = e);
            var t = this.C();
        ...
        this.show = function() {
            if (!this.Ab) {
                ...
                a.onTimeRangeSelected = function(e) {
                    ...
                    ,
                    "function" == typeof i.onTimeRangeSelect && (i.onTimeRangeSelect(e),
                    e.preventDefault.value) || (i.Mb(n),
                    i.close(),
                    "function" == typeof i.onTimeRangeSelected && i.onTimeRangeSelected(e))
                }
                ,
                this.navigator = a;
                var n = DayPilot.abs(e)
    ...
    if ("undefined" == typeof DayPilot.Menu || !DayPilot.Menu.def) {
        ...
        DayPilot.Menu = function(i) {
            ...
            this.show = function(i, o) {
                o = o || {};
                var r = null;
                if (i ? "string" == typeof i.id || "number" == typeof i.id ? r = i.id : "function" == typeof i.id ? r = i.id() : "function" == typeof i.value && (r = i.value()) : r = null,
                "undefined" != typeof DayPilot.Bubble && DayPilot.Bubble.hideActive(),
                o.submenu || t.menuClean(),
                this.Ob.submenu = null,
                null !== t.mouse) {
                    ...
                    if (this.showMenuTitle) {
                        ...
                        c.className = this.Pb("title"),
                        d.appendChild(c)
                    }
                    for (var u = 0; u < this.items.length; u++) {
                        var h = this.items[u]
                          , f = document.createElement("div");
                        if (DayPilot.Util.addClass(f, this.Pb("item")),
                        h.items && (DayPilot.Util.addClass(f, this.Pb("item_haschildren")),
                        DayPilot.Util.addClass(d, this.Pb("withchildren"))),
                        "undefined" != typeof h && !h.hidden) {
                            if ("-" === h.text) {
                                            ...
                                            return function(a) {
                                                ...
                                                var n = function() {
                                                    window.setTimeout(function() {
                                                        i.source.calendar && (i.source.calendar.internal.touch.active = !1)
                                                    }, 500)
                                                };
                                                if ("function" == typeof e.onClick) {
                                                    var o = {};
                                        ...
                                        var y = function(e, t) {
                                            return function(i) {
                                                ...
                                                if (a instanceof DayPilot.Link)
                                                    return void o.internal.linkMenuClick(n.command, a, n.action);
                                                ...
                                                if (a instanceof DayPilot.Task)
                                                    return void ("resource" === a.menuType ? o.internal.resourceHeaderMenuClick(n.command, t.menuSource, n.action) : o.internal.eventMenuClick(n.command, t.menuSource, n.action));
                                                switch (a.menuType) {
                                                case "resource":
                                ...
                                if (g.className = a.Pb("item_text"),
                                g.innerHTML = DayPilot.Util.escapeTextHtml(h.text, h.html),
                                p.appendChild(g),
                                h.image) {
                                ...
                                if (h.symbol) {
                                    ...
                                    P.setAttribute("href", h.symbol),
                                    C.appendChild(P);
                                    var k = document.createElement("span");
                                    k.className = a.Pb("item_symbol"),
                    ...
                    if (function() {
                        ...
                        if (e) {
                            var t = e.div
                              ...
                              , s = e.a;
                            if ("Visible" !== r && (s = DayPilot.Areas.createArea(t, i, a),
                            t.appendChild(s),
                            n = s),
                            s) {
                    ...
                    o.parentLink) {
                        var N = o.parentLink
                          , I = parseInt(new DayPilot.StyleReader(d).get("border-top-width"))
                          , O = DayPilot.abs(o.parentLink.parentNode)
                          , R = O.x + N.offsetWidth
                          , B = O.y - I;
                        R + T > H && (R = Math.max(0, O.x - T));
                        var U = document.body.scrollTop + document.documentElement.scrollTop;
                        B + M - U > A && (B = Math.max(0, A - M + U)),
                        d.style.left = R + "px",
                        d.style.top = B + "px"
                    }
                    d.style.display = "",
            ...
            this.Qb = function(e, t) {
                var i = e
                  , n = t.source;
                if ((!a.Ob.submenu || a.Ob.submenu.item !== e) && (a.Ob.submenu && a.Ob.submenu.item !== e && (DayPilot.Util.removeClass(a.Ob.submenu.link.parentNode, a.Pb("item_haschildren_active")),
                a.Ob.submenu.menu.hide(),
                a.Ob.submenu = null),
                e.items)) {
                    var o = a.cloneOptions();
                    o.items = e.items,
                    a.Ob.submenu = {},
                    a.Ob.submenu.menu = new DayPilot.Menu(o),
                    a.Ob.submenu.menu.Rb = a,
                    a.Ob.submenu.menu.show(n, {
                        "submenu": !0,
                        "parentLink": t,
                        "parentItem": i
                    }),
                    a.Ob.submenu.item = e,
                    a.Ob.submenu.link = t,
                    DayPilot.Util.addClass(t.parentNode, a.Pb("item_haschildren_active"))
                }
            }
            ,
            this.Pb = function(e) {
            ...
            this.hide = function(e) {
                e = e || {},
                this.Ob.submenu && this.Ob.submenu.menu.hide();
                var i = t.waitingSubmenu;
                if (i && (t.waitingSubmenu = null,
                clearTimeout(i.timeout)),
                this.removeShadow(),
                this.Ob.div && this.Ob.div.parentNode === document.body && document.body.removeChild(this.Ob.div),
                n && (DayPilot.de(n),
                n = null),
                a.Ob.visible = !1,
                a.Ob.source = null,
                a.Rb && e.hideParent && a.Rb.hide(e),
        ...
        DayPilot.MenuBar = function(e, t) {
            ...
            this.t = function() {
                ...
                DayPilot.list(i.items).forEach(function(e) {
                    ...
                    a.onmouseover = function() {
                        i.active && i.active.item !== e && i.Ub(a)
                    }
                    ,
                    t.appendChild(a),
            ...
            ,
            this.dispose = function() {
                this.Ia && (this.nav.top.innerHTML = "",
                this.elements.items = [])
            }
        }
        ,
        DayPilot.MenuBar.deactivate = function() {
            DayPilot.MenuBar.active && (DayPilot.MenuBar.active.Tb(),
...
function(DayPilot) {
    ...
    if (!DayPilot.ModalStatic) {
        ...
        var i = function() {
            ...
            e.add = function(e, a, n) {
                ...
                if (t.sheet.insertRule)
                    "undefined" == typeof n && (n = t.sheet.cssRules.length),
                    t.sheet.insertRule(e + "{" + a + "}", n);
                else {
                    if (!t.sheet.addRule)
        ...
        "undefined" != typeof navigator && navigator.userAgent.indexOf("Edge") !== -1 && n.add(".modal_default_form_item_date input::-ms-clear", "display: none;"),
        ...
        n.add(".modal_default_form_item_searchable_icon:after", "content:''; position: absolute; right: 5px; top: 50%; margin-top: -8px; width: 10px; height: 15px; background-image:url(" + a + ");"),
        ...
        n.add(".modal_default_form_item_time_icon:after", "content:''; position: absolute; right: 5px; top: 50%; margin-top: -8px; width: 10px; height: 15px; background-image:url(" + a + ");"),
        ...
        DayPilot.Modal = function(e) {
            ...
            this.showUrl = function(e) {
                ...
                if (this.useIframe) {
                    ...
                    i && (this.iframe.src = "about:blank",
                    this.setInnerHTML(this.id + "iframe", i)),
                    this.re(this.iframe, "load", this.bc),
                    this.iframe.src = e,
                    this.ob(),
                    this.$b(),
                    this._b()
            ...
            this.cc = function(e) {
                ...
                if (t) {
                    ...
                    ,
                    4 !== t.readyState && ("object" == typeof o && (o = JSON.stringify(o)),
                    t.send(o))
                }
            }
            ,
            ...
            ,
            this.$b = function() {
                this.Wb || (this.re(window, "resize", this.ic),
                this.re(window, "scroll", this.jc),
                this.dragDrop && (this.re(document, "mousemove", this.kc),
                this.re(document, "mouseup", this.lc)),
                this.Wb = !0)
            }
            ,
            this.nc = function() {
                this.ue(window, "resize", this.ic),
                this.ue(window, "scroll", this.jc),
                this.dragDrop && (this.ue(document, "mousemove", this.kc),
                this.ue(document, "mouseup", this.lc)),
                this.Wb = !1
            }
            ,
            this.oc = function(e) {
            ...
            this.kc = function(e) {
                if (t.Yb) {
                    ...
                    t.div.style.top = t.Xb.y + n + "px",
                    t.div.style.left = t.Xb.x + a + "px"
                }
            }
            ,
            this.lc = function(e) {
            ...
            ,
            this.sc = {},
            this.sc.container = function() {
                return t.container || document.body
            }
            ,
            this.sc.scrollY = function() {
                var e = t.sc.container();
            ...
            this.Zb = function() {
                ...
                o.style.width = "50px",
                o.style.height = "50px",
                this.dragDrop && (o.onmousedown = this.oc),
                o.addEventListener("keydown", function(e) {
                    e.stopPropagation()
                });
                var r = null;
                this.useIframe && (r = document.createElement("iframe"),
                r.id = this.id + "iframe",
            ...
            this.setInnerHTML = function(e, i) {
                ...
                t.autoStretch && (t.autoStretchFirstLoadOnly && t.tc || (t.stretch(),
                t.tc = !0))
            }
            ,
            ...
            this.hide = function(e) {
                ...
                i.preventDefault.value) || (this.div && (this.div.style.display = "none",
        ...
        r.prototype.render = function() {
            var e = this;
            this.zc = document.createElement("div"),
        ...
        r.prototype.createView = function(e) {
            ...
            if (a.className = t + "_form_item " + t + "_form_item_level" + e.level,
        ...
        ,
        r.prototype.Ac = function(e, t) {
            function i() {
                e.Bc && (e.Bc.remove(),
                e.Bc = null),
                e.zc.classList.add(u);
                var t = document.createElement("div");
                t.classList.add(h),
            ...
            if (d) {
                ...
                if (c.valid)
                    clearTimeout(this.yc[o.field]),
                    e.Bc && (e.Bc.remove(),
                    e.Bc = null),
                    e.zc.classList.remove(u);
                else if (!n)
                    if (a) {
                        var f = 1e3;
                        clearTimeout(this.yc[o.field]),
                        this.yc[o.field] = setTimeout(function() {
                            i()
                        }, f)
                    } else
                        i();
        ...
        r.prototype.updateDependentState = function() {
            var e = this
              , t = [!0];
            (this.xc ? this.xc : this.wc).forEach(function(i) {
            ...
            var t = this
              , i = {
                ...
                "textarea": function() {
                    ...
                    i.focus = function() {
                        i.element.focus(),
                        i.element.setSelectionRange(0, 0)
                    }
                    ,
                    i.save = function() {
                        var t = {};
                ...
                "select": function() {
                    ...
                    t.save = function() {
                        ...
                        a && "undefined" != typeof a.Ec && (t = a.Ec);
                        var n = {};
                        return n[e.field] = t,
                        n
                    }
        ...
        r.prototype.findRowsByField = function(e) {
            return this.wc.filter(function(t) {
                return t.field === e
            })
        }
        ,
          ...
          , d = function(e) {
            ...
            var t = this
              , i = {
                "selected": {
                    post: function(e) {
                        "object" == typeof e && e.id ? t.Gc = e : "string" != typeof e && "number" != typeof e || t.select(e)
                    }
                }
            };
        ...
        d.prototype.select = function(e) {
            return this.Gc = this.data.find(function(t) {
                return t.id === e
            }),
            this.Nc(!1),
            this
        ...
        d.prototype.create = function() {
            function e(e) {
                var i = l.strategy;
                "includes" !== l.strategy && "startsWith" !== l.strategy && (i = "includes"),
                e = e || i || "includes",
                h.style.display = "",
            ...
            function t(e) {
                ...
                l.Hc && (l.Hc.className += " " + l.theme + "_list_item_highlight",
                t && !i(l.Hc, h) && l.Hc.scrollIntoView())
            }
            function i(e, t) {
            ...
            m.addEventListener("keydown", function(e) {
                ...
                if ("ArrowDown" === e.key) {
                    ...
                    "Enter" === e.key ? l.Hc ? (e.stopPropagation(),
                    a(l.Hc)) : (e.stopPropagation(),
                    n(),
                    r()) : "Esc" !== e.key && "Escape" !== e.key || (e.stopPropagation(),
                    n(),
                    r())
            }),
            this.Jc = m,
            this.Kc = h,
            this.Gc || (this.Gc = this.data[0],
            this.Gc && (m.value = this.Gc.name)),
            c.appendChild(m),
            c.appendChild(u),
            c.appendChild(f),
            c.appendChild(h),
        ...
        d.prototype.Mc = function() {
            this.q(),
            this.Gc ? this.Jc.value = this.Gc.name : (this.Jc.value = "",
            this.Nc(!0))
        }
        ,
        d.prototype.focus = function() {
            this.Ic = !0,
            this.Jc.setAttribute("readonly", "readonly"),
            this.Jc.focus(),
            this.Mc()
        }
        ,
        ...
        ,
        d.prototype.Nc = function(e) {
            if (this.Lc.value = this.selected ? this.selected.id : null,
            this.Gc ? this.Jc.value = this.Gc.name : this.Jc.value = "",
        ...
        c.prototype.create = function() {
            ...
            o.spacer = !0;
            var r = this.Rc(o);
            r.classList.add(e.theme + "_spacer"),
            a.appendChild(r);
            var s = document.createElement("div");
        ...
        c.prototype.Uc = function() {
            ...
            return !!(e && this.wc.length >= e)
        }
        ,
        c.prototype.save = function() {
            var e = this
              , t = [];
            return e.wc.forEach(function(e) {
                var i = {};
        ...
        c.prototype.Wc = function() {
            ...
            this.Uc() ? this.nav.plus.classList.add(this.theme + "_plus_max") : this.nav.plus.classList.remove(this.theme + "_plus_max")
        }
        ,
        ...
        c.prototype.$c = function(e) {
            ...
            if ("text" === i || "number" === i) {
                ...
                a.addEventListener("keyup", function(a) {
                    "number" === i ? e.value = Number(this.value) : e.value = this.value,
                    t.Tc()
                }),
                a
            }
            if ("select" === i) {
                ...
                n.addEventListener("change", function(i) {
                    ...
                    a && "undefined" != typeof a.Ec && (e.value = a.Ec),
                    t.Tc()
                }),
                n
            }
...
function() {
    if ("undefined" == typeof DayPilot.Month || !DayPilot.Month.events) {
        ...
        e.Month = function(i, a) {
            ...
            this.V = function(e, t) {
                var e = JSON.parse(e);
                return e.CallBackRedirect ? void (document.location.href = e.CallBackRedirect) : "None" === e.UpdateType ? void n.fireAfterRenderDetached(e.CallBackData, !0) : (n.events.list = e.Events,
                "Full" === e.UpdateType && (n.startDate = e.StartDate,
                n.timeFormat = e.TimeFormat ? e.TimeFormat : n.timeFormat,
                "undefined" != typeof e.WeekStarts && (n.weekStarts = e.WeekStarts),
                n.hashes = e.Hashes),
                n.X(),
                n._c(),
                n.ga(),
                "Full" === e.UpdateType && (n.ad(),
                n.bd()),
                n.la(),
                n.show(),
                n.ma(),
                void n.fireAfterRenderDetached(e.CallBackData, !0))
            }
            ,
            this.fireAfterRenderDetached = function(e, t) {
                var i = function(e, t) {
                    return function() {
                        n.afterRender && n.afterRender(e, t)
                    }
                };
            ...
            this.events.load = function(e, t, i) {
                ...
                if (n.eventsLoadMethod && "POST" === n.eventsLoadMethod.toUpperCase())
                    ...
                    var r = e
                      , s = "start=" + n.visibleStart().toString() + "&end=" + n.visibleEnd().toString();
                    r += r.indexOf("?") > -1 ? "&" + s : "?" + s,
                    DayPilot.Http.ajax({
                        "method": "GET",
                        "url": r,
            ...
            this.events.forRange = function(e, t) {
                e = new DayPilot.Date(e),
                t = new DayPilot.Date(t);
                var i = (n.events.list || []).map(function(e) {
                ...
                i.filter(function(i) {
                    var a = i.start()
                      , n = i.end();
                    return a === n && a === e || DayPilot.Util.overlaps(e, t, a, n)
                })
            }
            ,
            this.update = function(e) {
                    ...
                    for (var i = 0; i < e.length; i++) {
                        ...
                        if (!(n.getTime() > o.getTime()))
                            for (var t = 0; t < this.rows.length; t++) {
                                ...
                                r.belongsHere(s) && (r.events.push(s),
                                "function" == typeof this.onBeforeEventRender && (s.cache = this.vb.events[i]))
                            }
                    }
            ...
            this.La = function(e) {
                !function() {
                    var i = e.domArgs;
                    if (e.domArgs = null,
                    i && "function" == typeof n.onBeforeEventDomRemove && n.onBeforeEventDomRemove(i),
                    i && "function" == typeof n.onBeforeEventDomAdd) {
                        var a = i && i.Ma;
                        if (a) {
                            n.Oa.Na && t(i.element) && (n.Oa.Pa = !0,
                            n.Oa.Qa(a),
                            n.Oa.Pa = !1)
                        }
                    }
            ...
            this.drawShadow = function(t, i, a, o, r, s) {
                ...
                for ("number" == typeof h && (h += "px"); l > 0 && i < this.rows.length; ) {
                    ...
                    y.style.left = this.getCellWidth() * t + "%",
                    y.style.width = this.getCellWidth() * f + "%",
                    y.style.top = p + "px",
                    y.style.height = v + "px",
                    y.style.cursor = u,
                    y.classList.add(n.K("_shadow"));
                    ...
                    g.style.left = "0px",
                    g.style.bottom = "0px",
                    g.classList.add(n.K("_shadow_inner")),
                    h && (l === o && (y.style.borderTopLeftRadius = h,
                    y.style.borderBottomLeftRadius = h,
                    g.style.borderTopLeftRadius = h,
                    g.style.borderBottomLeftRadius = h),
                    l <= f && (y.style.borderTopRightRadius = h,
                    y.style.borderBottomRightRadius = h,
                    g.style.borderTopRightRadius = h,
                    g.style.borderBottomRightRadius = h)),
                    this.nav.top.appendChild(y),
                    this.shadow.list.push(y),
                    l -= f + 7 - this.getColCount(),
                    t = 0,
                    i++
                }
            }
            ...
            ,
            this.Ra = function(i) {
                var a = i.cache || i.data
                  , o = a.borderRadius || n.eventBorderRadius;
                "number" == typeof o && (o += "px");
                var r = i.part.row
                  , s = i.part.line
                  , l = i.part.colStart
                  , d = i.part.colWidth
                  , c = this.getCellWidth() * l
                  , u = this.getCellWidth() * d
                  , h = this.getEventTop(r, s)
                  , f = document.createElement("div");
                f.setAttribute("unselectable", "on"),
                f.style.height = this.eventHeight + "px",
                f.style.overflow = "hidden",
                f.className = this.K("_event"),
                a.cssClass && DayPilot.Util.addClass(f, a.cssClass),
                i.part.startsHere || DayPilot.Util.addClass(f, this.K("_event_continueleft")),
                i.part.endsHere || DayPilot.Util.addClass(f, this.K("_event_continueright")),
                f.event = i,
                f.style.width = u + "%",
                f.style.position = "absolute",
                f.style.left = c + "%",
                f.style.top = h + "px",
                this.showToolTip && i.client.toolTip() && (f.title = i.client.toolTip()),
                f.onclick = n.ta,
                f.oncontextmenu = n.dd,
                f.onmousedown = function(t) {
                    ...
                    1 === a)
                        ...
                        "w-resize" === this.style.cursor || "e-resize" === this.style.cursor) {
                            ...
                            o.start.y = r,
                            o.event = f.event,
                            o.width = DayPilot.DateUtil.daysSpan(o.event.start(), o.event.end()) + 1,
                            o.direction = this.style.cursor,
                            e.resizingEvent = o
                            ...
                            var u = n.getCellBelowPoint(c.x, c.y)
                              , h = DayPilot.DateUtil.daysDiff(i.start(), n.rows[r].start)
                              , m = 7 * u.y + u.x - (7 * r + l);
                            h && (m += h);
                            var p = {};
                            p.start = {},
                            ...
                            p.start.y = r,
                            p.start.line = s,
                            p.offset = n.eventMoveToPosition ? 0 : m,
                            p.colWidth = d,
                            p.event = f.event,
                            p.coords = c,
                            e.movingEvent = p
                ...
                f.onmousemove = function(t) {
                    if ("undefined" != typeof e && !e.movingEvent && !e.resizingEvent) {
                        ...
                        if (a) {
                            ...
                            var n = 6;
                            a.x <= n && i.client.resizeEnabled() ? i.part.startsHere ? (f.style.cursor = "w-resize",
                            f.dpBorder = "left") : f.style.cursor = "not-allowed" : f.clientWidth - a.x <= n && i.client.resizeEnabled() ? i.part.endsHere ? (f.style.cursor = "e-resize",
                            f.dpBorder = "right") : f.style.cursor = "not-allowed" : i.client.clickEnabled() ? f.style.cursor = "pointer" : f.style.cursor = "default"
                        }
                    }
                }
                ,
                f.onmouseleave = function(e) {
                    f.deleteIcon && (f.deleteIcon.style.display = "none"),
                    f.style.cursor = ""
                }
                ,
                ...
                m.className = this.K("_event_inner"),
                "darker" === a.borderColor && a.backColor ? m.style.borderColor = DayPilot.ColorUtil.darker(a.backColor, 2) : m.style.borderColor = a.borderColor,
                a.backColor && (m.style.background = a.backColor),
                a.fontColor && (m.style.color = a.fontColor),
                o && (f.style.borderRadius = o,
                m.style.borderRadius = o),
                f.appendChild(m),
                i.client.barVisible()) {
                    var p = document.createElement("div");
                    p.setAttribute("unselectable", "on"),
                    p.className = this.K("_event_bar"),
                    p.style.position = "absolute";
                    var v = document.createElement("div");
                    v.setAttribute("unselectable", "on"),
                    v.className = this.K("_event_bar_inner"),
                    v.style.top = "0%",
                    v.style.height = "100%",
                    a.barColor && (v.style.backgroundColor = a.barColor),
                    p.appendChild(v),
                    f.appendChild(p)
                }
                if (i.client.deleteEnabled()) {
                    var y = Math.floor(n.eventHeight / 2 - 9)
                ...
                !function() {
                    ...
                    e.element = null,
                    f.domArgs = e,
                    "function" == typeof n.onBeforeEventDomAdd && n.onBeforeEventDomAdd(e),
                    e.element) {
                        var a = m;
                        if (a) {
                            e.Ma = a;
            ...
            this._c = function() {
                ...
                var e, t = (this.startDate,
                this.lastVisibleDayOfMonth()), i = DayPilot.DateUtil.daysDiff(this.firstDate, t) + 1;
                e = Math.ceil(i / 7),
                this.days = 7 * e,
                this.rows = [];
                for (var a = 0; a < e; a++) {
                    var o = {};
                    o.start = this.firstDate.addDays(7 * a),
                    ...
                    o.putIntoLine = function(e, t, i, a) {
                        for (var n = this, o = 0; o < this.lines.length; o++) {
                            var r = this.lines[o];
                            if (r.isFree(t, i))
                                return r.addEvent(e, t, i, a, o),
                                o
                        }
                        var r = [];
                        return r.isFree = function(e, t) {
                            for (var i = !0, a = 0; a < this.length; a++)
                                e + t - 1 < this[a].part.colStart || e > this[a].part.colStart + this[a].part.colWidth - 1 || (i = !1);
                            return i
                        }
                        ,
                        r.addEvent = function(e, t, i, a, o) {
                            ...
                            e.part.row = a,
                            e.part.line = o,
                            e.part.startsHere = n.start.getTime() <= e.start().getTime(),
                            e.part.endsHere = n.end.getTime() >= e.end().getTime(),
                            this.push(e)
                        }
                        ,
                ...
                t.onmousemove = function(t) {
                    if (e.resizingEvent) {
                        ...
                        if ("w-resize" === s.direction) {
                            ...
                            r = n.getCellFromDate(s.event.start()),
                            o = n.getWidth(r, a);
                        o < 1 && (o = 1),
                        n.drawShadow(r.x, r.y, 0, o)
                        ...
                        if (i.x === e.movingEvent.coords.x && i.y === e.movingEvent.coords.y)
                            return;
                        var c = 3
                          , u = Math.abs(i.x - e.movingEvent.coords.x) + Math.abs(i.y - e.movingEvent.coords.y);
                        if (u <= c)
                            return;
                        var a = n.getCellBelowPoint(i.x, i.y);
                        n.clearShadow();
                        var h = e.movingEvent.event
                          , f = e.movingEvent.offset
                          , o = n.cellMode ? 1 : DayPilot.DateUtil.daysSpan(h.start(), h.end()) + 1;
                        o < 1 && (o = 1),
                        n.drawShadow(a.x, a.y, 0, o, f, h)
                        ...
                        n.drawShadow(v.x, v.y, 0, o, 0, null)
                    }
                }
            }
            ,
            this.la = function() {
                ...
                for (var e = 0; e < this.cells.length; e++)
                    for (var t = 0; t < this.cells[e].length; t++)
                        ...
                        this.cells[e][t].style.height = this.rows[t].getHeight() + "px"
            }
            ,
            ...
            this.bd = function() {
                ...
                for (var t = 0; t < this.getColCount(); t++) {
                    ...
                    a > 6 && (a -= 7),
                    i.className = this.K("_header");
                    var n = document.createElement("div");
                    n.setAttribute("unselectable", "on"),
                    n.innerHTML = o.locale().dayNames[a],
                    i.appendChild(n),
                    n.style.position = "absolute",
                    n.style.top = "0px",
                    n.style.bottom = "0px",
                    n.style.left = "0px",
                    n.style.right = "0px",
                    n.className = this.K("_header_inner"),
                    n.innerHTML = o.locale().dayNames[a],
                    e.appendChild(i);
            ...
            this.db = function(e) {
                !function() {
                    var i = e.domArgs;
                    if (e.domArgs = null,
                    i && "function" == typeof n.onBeforeCellDomRemove && n.onBeforeCellDomRemove(i),
                    i && "function" == typeof n.onBeforeCellDomAdd) {
                        var a = i && i.Ma;
                        if (a) {
                            var o = n.fd.reactDOM && isReactCmp(i.element)
                              , r = n.Oa.Na && (isVueCmp(i.element) || t(i.element));
                            o ? n.fd.gd(a) : r && (n.Oa.Pa = !0,
                            n.Oa.Qa(a),
                            n.Oa.Pa = !1)
                        }
                    }
            ...
            ,
            this.ed = function(i, a, r) {
                var s = this.rows[a]
                  , l = this.firstDate.addDays(7 * a + i)
                  , d = l.getDay()
                  , c = null;
                ...
                f.control = n,
                f.cell = h,
                "function" == typeof n.onBeforeCellRender && n.onBeforeCellRender(f);
                var m = f.cell.properties
                  , p = document.createElement("div");
                if (p.setAttribute("unselectable", "on"),
                p.style.position = "absolute",
                p.style.cursor = "default",
                p.style.left = this.getCellWidth() * i + "%",
                p.style.width = this.getCellWidth() + "%",
                p.style.top = this.getRowTop(a) + "px",
                p.style.height = s.getHeight() + "px",
                p.className = this.K("_cell"),
                m.business) {
                    var u = this.K("_cell_business");
                    DayPilot.Util.addClass(p, u)
                }
                var v = (this.startDate.addMonths(-1).getMonth(),
                ...
                v.style.top = "0px",
                v.style.bottom = "0px",
                v.className = this.K("_cell_inner"),
                m.backColor && (v.style.backgroundColor = f.cell.properties.backColor),
                p.onmousedown = function(t) {
                    "Disabled" !== n.timeRangeSelectedHandling && (n.clearShadow(),
                ...
                y.style.height = this.cellHeaderHeight + "px",
                y.className = this.K("_cell_header"),
                y.onclick = function(e) {
                    if ("Enabled" === n.cellHeaderClickHandling) {
                        ...
                        ,
                        "function" == typeof n.onCellHeaderClick && (n.onCellHeaderClick(t),
                        t.preventDefault.value) || "function" == typeof n.onCellHeaderClicked && n.onCellHeaderClicked(t)
                    }
                }
                ,
                y.innerHTML = m.headerHtml,
                v.appendChild(y),
                m.html) {
                    var g = document.createElement("div");
                    g.style.height = s.getHeight() - this.cellHeaderHeight + "px",
                ...
                !function() {
                    if ("function" == typeof n.onBeforeCellDomAdd || "function" == typeof n.onBeforeCellDomRemove) {
                        ...
                        e.element = null,
                        p.domArgs = e,
                        "function" == typeof n.onBeforeCellDomAdd && n.onBeforeCellDomAdd(e),
                        e.element) {
                            var i = v;
                            if (i) {
                                e.Ma = i;
            ...
            this.T = function(e, t, i) {
                ...
                a.header = this.S();
                var n = "JSON" + DayPilot.JSON.stringify(a);
                this.backendUrl && DayPilot.request(this.backendUrl, this.U, n, this.ajaxError)
            }
            ,
            this.U = function(e) {
                n.V(e.responseText)
            ...
            this.eventClickSingle = function(e, t) {
                ...
                if (i && i.client.clickEnabled())
                    if (n.sa()) {
                        ...
                        ,
                        "function" == typeof n.onEventClick && (n.ua.apply(function() {
                            n.onEventClick(a)
                        }),
                        a.preventDefault.value))
                            return;
                        ...
                        "function" == typeof n.onEventClicked && n.ua.apply(function() {
                            n.onEventClicked(a)
                        })
                    } else
                        switch (n.eventClickHandling) {
            ...
            this.va = function(e) {
                ...
                ,
                "function" != typeof n.onEventRightClick || (n.onEventRightClick(t),
                !t.preventDefault.value)) {
                    ...
                    return "function" == typeof n.onEventRightClicked && n.onEventRightClicked(t),
                    !1
                }
            }
            ,
            this.wa = function(e) {
                if (n.sa()) {
                    ...
                    ,
                    "function" == typeof n.onEventDelete && (n.ua.apply(function() {
                        n.onEventDelete(t)
                    }),
                    t.preventDefault.value))
                        return;
                    ...
                    "function" == typeof n.onEventDeleted && n.ua.apply(function() {
                        n.onEventDeleted(t)
                    })
                } else
                    switch (n.eventDeleteHandling) {
            ...
            this.L = function(e, t, i, a, o, r) {
                ...
                if (n.sa()) {
                    ...
                    ,
                    "function" == typeof n.onEventMove && (n.ua.apply(function() {
                        n.onEventMove(p)
                    }),
                    ...
                    "function" == typeof n.onEventMoved && n.ua.apply(function() {
                        n.onEventMoved(p)
                    })
                } else
                    switch (n.eventMoveHandling) {
            ...
            this.J = function(e, t, i) {
                ...
                if (n.sa()) {
                    ...
                    ,
                    "function" == typeof n.onEventResize && (n.ua.apply(function() {
                        n.onEventResize(u)
                    }),
                    ...
                    "function" == typeof n.onEventResized && n.ua.apply(function() {
                        n.onEventResized(u)
                    })
                } else
                    switch (n.eventResizeHandling) {
            ...
            this.N = function(e, t) {
                if (this.sa()) {
                    ...
                    ,
                    "function" == typeof n.onTimeRangeSelect && (n.ua.apply(function() {
                    ...
                    "function" == typeof n.onTimeRangeSelected && n.ua.apply(function() {
            ...
            var o = this.ba;
            this.debug = function(e, t) {
                this.debuggingEnabled && (n.debugMessages || (n.debugMessages = []),
            ...
            ,
            this.nb = function() {
                e.globalHandlers || (e.globalHandlers = !0,
            ...
            ,
            this.Ya = function(e, t) {
                return n.ba.ca() ? DayPilot.Util.escapeTextHtml(e, t) : DayPilot.Util.isNullOrUndefined(t) ? DayPilot.Util.isNullOrUndefined(e) ? "" : e : t
            }
            ,
            this.Oa = {},
            this.Oa.Na = null,
            ...
            this.Oa.Sa = function(e, t, i) {
                ...
                if ("function" == typeof a.render) {
                    var o = e;
                    DayPilot.isArray(e) && (o = a.h("div", i, e)),
                    a.render(o, t)
                }
            }
            ,
            ...
            ,
            this.internal = {},
            this.internal.loadOptions = this.qb,
            this.internal.xssTextHtml = n.Ya,
            this.internal.enableVue = function(e) {
                n.Oa.Na = e
            }
            ,
            ...
            this.init = function() {
                return this.ub(),
                this.loadFromServer() ? void this.Db() : (this._c(),
                this.ga(),
                this.Ua(),
                this.bd(),
                this.t(),
...
function(DayPilot) {
    ...
    if ("undefined" == typeof DayPilot.Navigator || !DayPilot.Navigator.def) {
        ...
        DayPilot.Navigator = function(t, i) {
            ...
            this.hd = function() {
                this.root.dp = this,
                this.root.className = this.K("_main"),
                "Horizontal" === this.orientation ? (r.jd() || (this.root.style.width = this.showMonths * (7 * r.cellWidth() + this.kd()) + "px"),
                this.root.style.height = 6 * this.cellHeight + this.titleHeight + this.dayHeaderHeight + "px") : r.jd() || (this.root.style.width = 7 * r.cellWidth() + this.kd() + "px"),
            ...
            ,
            this.od = function() {
                return r.jd() ? null : r.cellWidth()
            }
            ,
            this.pd = function(e) {
                return "number" != typeof e && (e = 1),
                r.jd() ? this.nd() * e : this.od() * e
            }
            ,
            this.qd = function(e) {
                var t = r.jd() ? "%" : "px";
            ...
            this.bd = function(t, i) {
                ...
                n.days = [],
                n.weeks = [];
                var o = this.startDate.addMonths(t)
                  , s = i.before
                  , l = i.after
                  , d = o.firstDayOfMonth()
                  , c = d.firstDayOfWeek(r.weekStarts())
                  , u = d.addMonths(1)
                  , h = DayPilot.DateUtil.daysDiff(c, u)
                  , f = "Auto" === this.rowsPerMonth ? Math.ceil(h / 7) : 6;
                n.rowCount = f;
                var m = (new DayPilot.Date).getDatePart()
                  , p = 7 * r.cellWidth() + this.kd();
                n.width = p;
                var v = this.cellHeight * f + this.titleHeight + this.dayHeaderHeight;
                n.height = v;
                var y = document.createElement("div");
                if (r.jd() ? "Horizontal" === this.orientation && (y.style.width = 100 / a.showMonths + "%") : y.style.width = p + "px",
                y.style.height = v + "px",
                "Horizontal" === this.orientation)
                    y.style.position = "absolute",
                    r.jd() ? (y.style.left = 100 / a.showMonths * t + "%",
                    n.leftPct = 100 / a.showMonths * t) : y.style.left = p * t + "px",
                    y.style.top = "0px",
                    n.top = 0,
                    n.left = p * t;
                else {
                ...
                D.setAttribute("unselectable", "on"),
                D.className = this.K("_titleleft"),
                i.left && (D.style.cursor = "pointer",
                ...
                x.style.left = a.qd(),
                x.style.top = "0px",
                x.style.width = a.qd(a.showWeekNumbers ? 6 : 5),
                x.style.height = this.titleHeight + "px",
                x.style.lineHeight = this.titleHeight + "px",
                x.setAttribute("unselectable", "on"),
                x.className = this.K("_title"),
                x.innerHTML = r.locale().monthNames[o.getMonth()] + " " + o.getYear(),
                y.appendChild(x),
                this.ti = x;
                var w = document.createElement("div");
                w.style.position = "absolute",
                w.style.left = a.qd(a.showWeekNumbers ? 7 : 6),
                w.style.right = a.qd(a.showWeekNumbers ? 7 : 6),
                w.style.top = "0px",
                w.style.width = a.qd(),
                w.style.height = this.titleHeight + "px",
                w.style.lineHeight = this.titleHeight + "px",
                w.setAttribute("unselectable", "on"),
                w.className = this.K("_titleright"),
                i.right && (w.style.cursor = "pointer",
                w.innerHTML = "<span>&gt;</span>",
                w.onclick = this.sd),
                y.appendChild(w),
                this.tr = w;
                var C = (this.kd(),
                a.showWeekNumbers ? 1 : 0);
                ...
                for (var M = 0; M < 7; M++) {
                    ...
                    var S = document.createElement("div");
                    S.style.position = "absolute",
                    S.style.left = a.qd(M + C),
                    S.style.right = a.qd(M + C),
                    S.style.top = this.titleHeight + "px",
                    S.style.width = a.qd(),
                    S.style.height = this.dayHeaderHeight + "px",
                    ...
                    S.setAttribute("unselectable", "on"),
                    S.className = this.K("_dayheader"),
                    S.innerHTML = "<span>" + this.td(M) + "</span>",
                    y.appendChild(S),
                    n.days.push(S);
                    for (var P = 0; P < f; P++) {
                        var k = c.addDays(7 * P + M)
                          , T = this.ud(k) && "none" !== this.vd()
                          , A = k.firstDayOfMonth() === o
                          , H = k < o
                          , E = k >= o.addMonths(1);
                        if ("month" === this.vd())
                            T = T && A;
                        ...
                        I.showBefore = s,
                        I.showAfter = l,
                        I.className = this.K(A ? "_day" : "_dayother"),
                        a.ld(I, "cell"),
                        k.getTime() === m.getTime() && A && this.ld(I, "today"),
                        0 !== k.dayOfWeek() && 6 !== k.dayOfWeek() || this.ld(I, "weekend"),
                        I.style.position = "absolute",
                        I.style.left = R + U,
                        I.style.right = R + U,
                        I.style.top = B + "px",
                        I.style.width = a.qd(),
                        I.style.height = this.cellHeight + "px",
                        I.style.lineHeight = this.cellHeight + "px";
                        var z = document.createElement("div");
                        z.style.position = "absolute",
                        z.className = k.getTime() === m.getTime() && A ? this.K("_todaybox") : this.K("_daybox"),
                        a.ld(z, "cell_box"),
                        z.style.left = "0px",
                        z.style.top = "0px",
                        z.style.right = "0px",
                        ...
                        if (L.day = k,
                        L.isCurrentMonth = A,
                        L.isToday = k.getTime() === m.getTime() && A,
                        L.isWeekend = 0 === k.dayOfWeek() || 6 === k.dayOfWeek(),
                        j ? (L.html = j.html || k.getDay(),
                        L.cssClass = j.css) : (L.html = k.getDay(),
                        L.cssClass = null),
                        "function" == typeof a.onBeforeCellRender) {
                            var W = {};
                            W.cell = L,
                            a.onBeforeCellRender(W),
                            j = W.cell
                        }
                        if (j && DayPilot.Util.addClass(I, j.cssClass || j.css),
                        A || s && H || l && E) {
                            var F = document.createElement("div");
                            F.innerHTML = k.getDay(),
                            F.style.position = "absolute",
                            F.style.left = "0px",
                            F.style.top = "0px",
                            F.style.right = "0px",
                        ...
                        function() {
                            if ("function" == typeof a.onBeforeCellDomAdd || "function" == typeof a.onBeforeCellDomRemove) {
                                ...
                                t.element = null,
                                I.domArgs = t,
                                "function" == typeof a.onBeforeCellDomAdd && a.onBeforeCellDomAdd(t),
                                t.element) {
                                    var i = z;
                                    if (i) {
                                        t.Ma = i;
                ...
                J.style.left = "0px",
                J.style.top = b - 2 + "px",
                J.style.width = a.qd(7 + C),
                J.style.height = "1px",
                J.style.fontSize = "1px",
                J.style.lineHeight = "1px",
                J.className = this.K("_line"),
                y.appendChild(J),
                this.months.push(n)
            }
            ,
            this.wd = function(e, t) {
            ...
            ,
            this.yd = function(e, t, i) {
                var n = e.month.cells[t][i];
                a.ld(n, "select")
            }
            ,
            this.zd = function(e, t, i) {
                var n = e.month.cells[t][i];
                a.md(n, "select")
            }
            ,
                    ...
                    for (var e = 0; e < this.showMonths; e++)
                        for (var t = 0; t < 7; t++)
                            for (var i = 0; i < 6; i++) {
                                ...
                                a && (1 === this.items[a.day.toStringSortable()] ? (this.ld(a, "busy"),
                                this.md(a, "free")) : (this.md(a, "busy"),
                                this.ld(a, "free")))
                            }
            }
            ,
            this.Bd = function() {
                ...
                e.selectionStart = a.selectionStart,
                e.selectionEnd = a.selectionEnd.addDays(1),
            ...
            this.select = function(e, t, i) {
                ...
                if (d) {
                    ...
                    (this.selectionStart < this.Ed() || this.selectionStart >= this.Fd()) && (m = this.selectionStart.firstDayOfMonth()),
                    m.toStringSortable() !== this.startDate.toStringSortable() && (f = !0),
                    this.startDate = m
                }
                s && a.freeHandSelectionEnabled ? a.selectionEnd = new DayPilot.Date(s) : this.Cd(),
                this.ad(),
                this.hd(),
                this.Gd(),
                this.Ad(),
                this.Bd(),
                !c || u.equals(this.selectionStart) && h.equals(this.selectionEnd) || this.N(),
                f && this.Hd()
            }
            ,
            this.update = function(e) {
            ...
            this.Id = function(e) {
                ...
                this.Ia) {
                    ...
                    a.ob(),
                    t.start === a.selectionStart && t.end === a.selectionEnd && t.day === a.selectionDay || a.N()
                }
            }
            ,
            this.ob = function() {
            ...
            this.T = function(e, t, i) {
                ...
                this.backendUrl ? DayPilot.request(this.backendUrl, this.U, n, this.Kd) : WebForm_DoCallback(this.uniqueID, n, this.V, null, this.callbackError, !0)
            }
            ,
            this.Kd = function(e) {
            ...
            this.Od = function() {
                ...
                var e = a.months[0].cells[0][0]
                  , t = e.clientWidth;
                a.Pd = t,
                a.months.forEach(function(e) {
                    e.width = e.div.clientWidth,
                    "Horizontal" === a.orientation && (e.left = e.div.offsetLeft),
                    e.cells.forEach(function(e, i) {
            ...
            this.Rd = function(e) {
                if (a.freeHandSelectionEnabled) {
                    ...
                    a.months[t.month].cells[t.x][t.y],
                    e.preventDefault()
                }
            }
            ,
            ...
            n.drawCell = function(e) {
                ...
                u.style.left = s + l,
                u.style.top = o + "px",
                u.style.height = a.cellHeight + "px",
                u.style.width = d,
                u.style.backgroundColor = "#ccc",
                u.style.opacity = .5,
                u.style.cursor = "default",
                a.nav.preselection.appendChild(u),
                n.cells.push(u)
            }
            ,
            n.clear = function() {
            ...
            n.ordered = function() {
                var e = n.start
                  , t = n.end
                  , i = {};
                return !t || new o(e).before(t) ? (i.start = e,
                i.end = t) : (i.start = t,
                i.end = e),
                i
            }
            ...
            this.xd = function(e) {
                ...
                if (i.cells[n][o].isClickable) {
                    ...
                    case "day":
                        ...
                        a.yd(t, n, o),
                        a.selected.push(l),
                        a.selectionStart = l.day,
                        a.selectionEnd = l.day;
                        break;
                    case "week":
                        if (a.autoFocusOnClick) {
                            var s = i.cells[0][o].day
                              , d = i.cells[6][o].day;
                        ...
                        for (var c = 0; c < 7; c++)
                            a.yd(t, c, o),
                            a.selected.push(i.cells[c][o]);
                        a.selectionStart = i.cells[0][o].day,
                        a.selectionEnd = i.cells[6][o].day;
                        break;
                    case "month":
                        if (a.autoFocusOnClick) {
                            var s = r;
                        ...
                        for (var s = null, d = null, o = 0; o < 6; o++)
                            for (var n = 0; n < 7; n++) {
                                var l = i.cells[n][o];
                                l && l.day.getYear() === r.getYear() && l.day.getMonth() === r.getMonth() && (a.yd(t, n, o),
                                a.selected.push(l),
                                null === s && (s = l.day),
                                d = l.day)
                            }
            ...
            this.N = function(e) {
                var t = a.selectionStart
                  , i = a.selectionEnd.addDays(1)
                  , n = DayPilot.DateUtil.daysDiff(t, i)
                  , o = a.selectionDay;
                if (e = e || {},
                a.sa()) {
                    var r = {};
                    ...
                    r.day = o,
                    r.days = n,
                    r.mode = e.mode || a.selectMode,
                    r.preventDefault = function() {
                        this.preventDefault.value = !0
                    }
                    ,
                    "function" == typeof a.onTimeRangeSelect && (a.onTimeRangeSelect(r),
                    ...
                    case "Bind":
                        if ("object" == typeof bound) {
                            ...
                            s.days = n,
                            s.day = o,
                            bound.commandCallBack(a.command, s)
                        }
                        break;
                    case "None":
                        break;
                    case "PostBack":
                        a.timeRangeSelectedPostBack(t, i, o)
                    }
            ...
            this.Hd = function() {
                ...
                if (a.sa()) {
                    ...
                    ,
                    "function" == typeof a.onVisibleRangeChange && (a.onVisibleRangeChange(i),
                    i.preventDefault.value))
                        return;
            ...
            this.Gd = function() {
                ...
                this.root.style.height = this.Wd() + "px",
            ...
            this.Oa.Sa = function(e, t) {
                ...
                if ("function" == typeof i.render) {
                    var n = e;
                    DayPilot.isArray(e) && (n = i.h("div", null, e)),
                    i.render(n, t)
                }
            }
            ,
            ...
            ,
            this.internal = {},
            this.internal.loadOptions = a.qb,
            ...
            r.cellWidth = function() {
                ...
                return e || (e = a.cellWidth),
                a.vb.cellWidth = e,
                e
            }
            ,
            r.jd = function() {
                return "Auto" === a.ba.cellWidth()
            }
            ,
            this.clearSelection = function() {
            ...
            this.Xd = function(e) {
                ...
                t.style.top = "-2000px",
                t.style.left = "-2000px",
                t.className = this.K(e);
                var i = a.root || document.body;
                i.appendChild(t);
            ...
            ,
            this.$d = function() {
                a.nav.top.onmousedown = this.Rd,
                a.nav.top.onmousemove = this.Sd
            }
            ,
            this.nb = function() {
                DayPilot.re(document, "mouseup", a._d)
            }
            ,
            this._d = function(e) {
                if (n.start && n.end) {
                    ...
                    n.clear();
                    var i = n.ordered();
                    i.start = new o(i.start).nextVisible(),
                    i.end = new o(i.end).previousVisible(),
                    a.selectionDay = new o(i.start).date(),
                    a.selectionStart = a.selectionDay,
                    a.selectionEnd = new o(i.end).date(),
                    n.start = null,
                    n.end = null,
                    a.ad(),
                    a.hd(),
